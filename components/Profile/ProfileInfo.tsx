  ...
  return (
    <div className="flex flex-col items-center mb-8">
      ...
      {isLoading ? (
        ...
        <p className="text-red-500 text-sm">{(error as Error).message || "An error occurred"}</p>
      ) : (
        <>
          ...
          <div className="relative flex w-full justify-around border-y border-gray-200 py-4">
            <div className="text-center flex-1">
              ...
              <p className="text-2xl font-semibold text-primary font-sora">{userData?.pollsCreated || 0}</p>
            </div>
            ...
            <div className="text-center flex-1">
              ...
              <p className="text-2xl font-semibold text-primary font-sora">{userData?.pollsParticipated || 0}</p>
            </div>
          </div>
        </>
      )}
